...
> Step 0–4 已完成；Step 5 readiness Git/PR 已获授权并正在交付；后续仍按 Step 分段授权。
...
| R-002 | Official MCP Registry 登记 | **已批准；Step 5 readiness Git/PR 交付中** | Registry API 与下游聚合器可发现已发布 Server | 固定 `io.github.wcnm8888/mcp1-weather-query` 身份、GitHub OAuth、分段发布与官方 API/安装复验 | 修改业务代码、第二 Tool、新 PyPI 版本、社区多平台铺开 | R-001 已关闭；公开 PyPI 0.1.0；每个外部门禁单独授权 | L |
