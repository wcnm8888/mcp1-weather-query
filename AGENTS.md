...
- 生命周期：roadmap 已批准；F-001、F-002、D-001、R-001 均已关闭；R-002 Step 0–9 已完成，
  Step 10 已获授权并正在完成发布后文档、测试与 closure PR 收口。
...
- 当前只允许完成 R-002 Step 10；不得跨入 Step 11 或执行新的 Registry 操作。
- Step 10 已获凭据处置和 closure PR 授权；固定官方 logout 已完成。已发布的 `0.1.0`
  不得重复 publish，closure PR 不得由代理自行合并。
